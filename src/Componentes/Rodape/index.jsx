  ...
  return (
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="social-icons">
          ...
          <a href="https://www.threads.net/@seu_usuario" target="_blank" rel="noreferrer">
            ...
            <a href="https://wa.me/5581994644959" target="_blank" rel="noreferrer">
              <FaWhatsapp />
            </a>
        </div>
      ...
      <div className="footer-copy">
          &copy; 2025 PI Arte & Frequência - Contato: piartefrequencia@gmail.com - Todos os direitos reservados.
        </div>
    </footer>
  );
};
