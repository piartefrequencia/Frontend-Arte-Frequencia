...
export default function CadastroColaborador() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.post("/colaborador", payload, {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="font-display text-3xl font-bold text-foreground">
            Cadastro de <span className="text-gradient-gold">Colaborador / Educador</span>
          </h1>
          <p className="text-muted-foreground text-sm">Registre um novo profissional ou estagiário.</p>
        </div>
      </div>
        ...
        <Card className="border-border/40 bg-card/40">
          ...
          <CardContent className="p-6 pt-0 space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-5">
              <div className="space-y-1">
                <label className="text-xs font-semibold text-muted-foreground">CPF (Somente Números)</label>
        ...
        <Card className="border-border/40 bg-card/40">
          ...
          <CardContent className="p-6 pt-0 space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1">
                <label className="text-xs font-semibold text-muted-foreground">Área de Instrução (Ex: Metais, Percussão)</label>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="space-y-1">
                <label className="text-xs font-semibold text-muted-foreground">Como gosta de ser chamado (Apelido)</label>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1">
                <label className="text-xs font-semibold text-muted-foreground">Rede Social (Instagram/Facebook)</label>
