...
import { User, Heart, Calendar, GraduationCap, Phone, MapPin, X, FileSpreadsheet } from "lucide-react";
...
export default function Listapublico() {
    ...
    <div className="space-y-8 py-8">
      ...
      <div className="border-b border-border/40 pb-6">
        <h1 className="font-display text-3xl font-bold text-foreground">
          Chamada dos <span className="text-gradient-gold">Alunos</span>
        </h1>
        <p className="text-muted-foreground text-sm">
          Filtre os alunos por oficinas para verificar dados de contato ou informações importantes.
        </p>
      </div>
